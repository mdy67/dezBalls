...
import org.firstinspires.ftc.teamcode.OLDs.messages.TwoDeadWheelInputsMessage;

@Config
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2968.810119391312; // y state of the parallel encoder (in tick units)
        public double perpXTicks = -17; // x state of the perpendicular encoder (in tick units)
    }
